...
export default class Demo2 extends React.Component<any, any> {
    ...
    render() {
        ...
        return <div className="main-container">
            <h3>Custom Rendering (AutoComplete, Operator) <a style={{fontSize:12}} href="https://github.com/nhabuiduc/react-filter-box/blob/master/src/example/demo2.tsx">Source</a></h3>
